...
#
##
# Import os.path library for filepath integrity and cleanup
import os.path
...
def classify_images(images_dir, results_dic, model):
    ...
    # that indicates the folder and the filename (key, value) to be used in the 
    # classifier function
    for key, value in results_dic.items():
        ...
        # Boolean - integer conversion for the results conditionals
        match = int(truth in model_label)
        value.extend((model_label, match)) # if not found then added to dict as NOT a match
